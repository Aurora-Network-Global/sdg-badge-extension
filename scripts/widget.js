(function (window, document) {
      ...
      options.predictionResponse.predictions.sort((a, b) => (a.prediction > b.prediction ? -1 : 1)).forEach(
        (prediction, index) => {
          if (index < 3) {
            ...
            boxSpan.src = (typeof chrome !== 'undefined' && chrome.runtime) 
              ? chrome.runtime.getURL('assets/img/sdg_icon_' + prediction.sdg.code + '.png')
              : '/assets/img/sdg_icon_' + prediction.sdg.code + '.png'
  ...
  const getOrCreateLegendList = (chart, id) => {
    ...
    auroraLogo.src = (typeof chrome !== 'undefined' && chrome.runtime) 
      ? chrome.runtime.getURL('assets/img/aurora_logo.png')
      : 'assets/img/aurora_logo.png'
    ...
    euLogo.src = (typeof chrome !== 'undefined' && chrome.runtime) 
      ? chrome.runtime.getURL('resources/EU-co-funded.jpg')
      : 'https://aurora-sdg.labs.vu.nl/resources/EU-co-funded.jpg'
  ...
  function main() {
    jQuery(document).ready(function ($) {
      const cssUrl = (typeof chrome !== 'undefined' && chrome.runtime) 
        ? chrome.runtime.getURL("assets/css/widget.css")
      ...
      $('.sdg-wheel').each(function (i, div) {
        ...
        // Check if data is already available from the extension
        let predictionResponse = div.sdgData;
        if (predictionResponse) {
          // Use existing data from extension
          processSDGData(predictionResponse);
        } else {
        ...
        function processSDGData(predictionResponse) {
              ...
              plugins: [htmlLegendPlugin,
                {
                  afterDraw: chart => {
                    ctx.save();
                    var image = new Image();
                    image.src = (typeof chrome !== 'undefined' && chrome.runtime) 
                      ? chrome.runtime.getURL('resources/SDG_logo.png')
                      : 'https://aurora-sdg.labs.vu.nl/resources/SDG_logo.png';
  ...
  /* Load jQuery */
  const jqueryUrl = (typeof chrome !== 'undefined' && chrome.runtime) 
    ? chrome.runtime.getURL("resources/jquery.min.js")
    : "https://aurora-sdg.labs.vu.nl/resources/jquery.min.js";
    
  loadScript(jqueryUrl, function () {
    /* load Chart.js */
    const chartUrl = (typeof chrome !== 'undefined' && chrome.runtime) 
      ? chrome.runtime.getURL("resources/chart.min.js")
      : "https://aurora-sdg.labs.vu.nl/resources/chart.min.js";
      
    loadScript(chartUrl, function () {
